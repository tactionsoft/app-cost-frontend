...
const PageSeven = ({ onButtonClick }) => {
  ...
  const [index6value, setIndex6value] = useState({ value1: 0, value2: 0, value3: 0, value4: 0, value5: 0, value6: 0 });
...
//     costData[5] = index6value; // Store at index 5 (5th position)
