...
const PageEleven = ({ onButtonClick }) => {
  const [singleUser, setSingleUser] = useState(false);
  const [multiUser, setMultiUser] = useState(false);
  const [thirdUser, setThirdUser] = useState(false);
  const [index10value, setIndex10value] = useState({ value1: 0, value2: 0, value3: 0, value4: 0, value5: 0, value6: 0 });
...
//     costData[9] = index10value; // Store at index 3 (4th position)
