...
const PageFourteen = ({ onButtonClick }) => {
  ...
  const [index13value, setIndex13value] = useState({ value1: 0, value2: 0, value3: 0, value4: 0, value5: 0, value6: 0 });
...
//     costData[11] = index13value; // Store at index 5 (5th position)
...
const calculateTotalCost = () => {
  ...
  let costData = JSON.parse(sessionStorage.getItem("finalCostPrice")) || [];
  costData[11] = index13value; // Ensure correct index
  sessionStorage.setItem("finalCostPrice", JSON.stringify(costData));
