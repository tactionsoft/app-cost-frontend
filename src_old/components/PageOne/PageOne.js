...
const PageOne = ({ onButtonClick,setCompletedPages }) => {
  ...
  // useEffect(() => {
  //   // Ensure Page One is always marked as completed
  //   setCompletedPages(prev => ({ ...prev, pageone: true }));
  // }, [setCompletedPages]);
  ...
  return (
    <main className="pt5 black-80 industry-all-content" style={{ maxWidth: "70%", maxHeight: "25%", margin: "auto" }}>
      ...
      <div class="industry-type">
        ...
        <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "bankingUser" ? "#18d2e8" : "#EAEEF5" }}
            onClick={() => handleClick("bankingUser")}
          >
            <img src={bankingUser} className="icon-size" title="multi user icon" alt="users-icon" />
            <h1 className={`f4 pl2 pr2 card-title ${selectedUser === "bankingUser" ? 'selected' : ''}`}>
              Banking</h1>
          </div>
        <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "engineeringConstructionUser" ? "#18d2e8" : "#EAEEF5" }}
        ...
        >
          ...
          <h1 className={`f4 pl2 pr2 card-title ${selectedUser === "engineeringConstructionUser" ? 'selected' : ''}`}>
            Engineering & Construction</h1>
        </div>
        <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "entertainmentUser" ? "#18d2e8" : "#EAEEF5" }}
        ...
        <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "healthcareUser" ? "#18d2e8" : "#EAEEF5" }}
...
>
  ...
  <h1 className={`f4 pl2 pr2 card-title ${selectedUser === "healthcareUser" ? 'selected' : ''}`}>
    Healthcare
        ...
        <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "informationTechnologiesUser" ? "#18d2e8" : "#EAEEF5" }}
          ...
          >
            ...
            <h1 className={`f4 pl2 pr2 card-title ${selectedUser === "informationTechnologiesUser" ? 'selected' : ''}`}>
              Information technologies</h1>
          </div>

        </div>
        <div className="industry-block-two ph4 selectionDiv">
        <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "insuranceUser" ? "#18d2e8" : "#EAEEF5" }}
          ...
          <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "investmentUser" ? "#18d2e8" : "#EAEEF5" }}
          ...
          <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "lendingUser" ? "#18d2e8" : "#EAEEF5" }}
            onClick={() => handleClick("lendingUser")}
          >
            <img src={lendingUser} className="icon-size" title="third user icon" alt="users-icon" />
            <h1 className={`f4 pl2 pr2 card-title ${selectedUser === "lendingUser" ? 'selected' : ''}`}>
              Lending</h1>
          </div>
          <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "manufacturingUser" ? "#18d2e8" : "#EAEEF5" }}
        ...
        <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "oilgasUser" ? "#18d2e8" : "#EAEEF5" }}
          ...
          <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "paymentsUser" ? "#18d2e8" : "#EAEEF5" }}
        ...
        <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "professionalServicesUser" ? "#18d2e8" : "#EAEEF5" }}
          ...
          <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "publicSectorUser" ? "#18d2e8" : "#EAEEF5" }}
          ...
          <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "realEstateUser" ? "#18d2e8" : "#EAEEF5" }}
        ...
        <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "retailwholesaleUser" ? "#18d2e8" : "#EAEEF5" }}
          ...
          <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "telecommUser" ? "#18d2e8" : "#EAEEF5" }}
          ...
          <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "transportationUser" ? "#18d2e8" : "#EAEEF5" }}
          ...
          <div className="industry-card br3 pa3 mv3 ba dib b--black-10 ma3" style={{ borderColor: selectedUser === "utilitiesUser" ? "#18d2e8" : "#EAEEF5" }}
          ...
          <div className={`industry-card br3 pa3 mv3 ba dib b--black-10 ma3 ${selectedUser === "othersUser" ? 'active' : ''}`}style={{ borderColor: selectedUser === "othersUser" ? "#18d2e8" : "#EAEEF5" }}
