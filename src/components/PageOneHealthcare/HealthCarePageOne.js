...
import "./MedicalPageOne.css";

const PageOneHealthcare = ({ onButtonClick,totalCost,setTotalCost}) => {
...
useEffect(() => {
  ...
  return (
    <main
      className="pt5 black-80 body-background Healthcare-pageone"
...
export default PageOneHealthcare;
