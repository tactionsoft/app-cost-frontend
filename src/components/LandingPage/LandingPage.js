...
const LandingPage = ({ setCompletedPages, setPage }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // ✅ Validate Form Data
    if (
      !formData["ebook-form-name"] ||
      !formData["ebook-email"] ||
      !formData["ebook-requirement"]
    ) {
    ...
    try {
      ...
      const sendEmail = (
        ...
        message,
        ccEmail = "",
        senderName = "Taction Software LLC"
      ) => {
        ...
        return emailjs
          ...
          .then((response) =>
            console.log(`Email sent to ${recipientEmail}:`, response.status)
          )
          .catch((error) =>
  ...
  return (
    <>
        ...
        <div className="topbar row d-flex ">
          <div className="container  d-flex flex-row align-items-center  justify-content-md-between">
            ...
            <div
              ...
              className=" social-links d-none d-md-flex align-items-center"
            >
              <a href="https://twitter.com/TactionSoft" className="twitter">
                <i className="bi bi-twitter-x"></i>
              </a>
              <a
                href="https://www.facebook.com/tactionsoftware/"
                className="facebook"
              >
                <i className="bi bi-facebook"></i>
              </a>
              <a
                href="https://in.linkedin.com/company/taction-software-llc"
                className="linkedin"
              >
                <i className="bi bi-linkedin"></i>
              </a>
              <a
                href="https://www.instagram.com/tactionsoftwarellc/"
                className="instagram"
              >
      ...
      {/* Navbar */}
      <nav
        className="navbar navbar-expand-lg sticky-wrapper"
        id="sticky-wrapper"
          ...
          <div className="row">
            <div className="col-lg-6 col-12 col-md-5 banner-content">
              <h1 className="text-white mb-4 landing-text banner-title">
                ...
                <strong>
                  App Cost Calculator | Estimate Your Mobile -{" "}
                  <span>
                    <strong>App Development Cost Instantly</strong>
                  </span>{" "}
                </strong>
              </h1>

              <p>
                Use our <strong> App Cost Calculator</strong> to get an instant
                estimate for your mobile <strong>App development cost</strong>.
                Customize features, platforms, and design to get a real-time
                price estimate. Start planning your{" "}
                <strong>App budget today!</strong>
              </p>
              <div className="col-lg-8 col-md-10 col-8 mx-auto">
                <button
                  ...
                  type="submit"
                  className="form-control-side  btn-success"
                >
            ...
            <div className="hero-image-wrap col-lg-6 col-12 col-md-7 mt-3 mt-lg-0">
              <div className="" id="calculator-form">
                {" "}
                <img src={online} />{" "}
              </div>
              <form
                onSubmit={handleSubmit}
                className="custom-form ebook-download-form shadow banner-form"
                action="#"
                method="post"
                role="form"
              >
                <div className="text-center title-text mb-5">
                  <h3 className="mb-1">
                    Estimate Your App Budget – Just One Step Away!
                  </h3>
                </div>
                  ...
                  {[
                    ...
                    <div className="input-group mb-4" key={index}>
                      <input
                        ...
                        required={field.name !== "ebook-contact"}
              ...
              >
                <nav class="nav nav-pills flex-column">
                  <a
                    ...
                    href="#item-1"
                  >
                    <strong>Why Use Our App Cost Calculator?</strong>
                  </a>
                  <a
                    className={`nav-link ${
                    ...
                    href="#item-2"
                  >
                    <strong>How the App Cost Calculator Works?</strong>
                  </a>
                  <a
                    className={`nav-link ${
            ...
            <div class="col-lg-8 col-12">
              ...
              >
                <div class="scrollspy-example-item right-side-content">
                  ...
                  <p>
                    Developing a mobile app involves multiple cost factors,
                    including UI/UX design, backend development, integrations,
                    security, and compliance. With our mobile app cost
                    estimator, you can:
                  </p>
                  ...
                  <div class="app-calculator">
                    ...
                    <div class="col-lg-6 col-12">
                      <div class="app_cost-calculator-right">
                        <p>
                          <strong>Get a quick estimate</strong> for your app
                          development budget.
                        </p>
                        <p>
                          <strong>Compare costs</strong> for different platforms
                          like iOS, Android, or hybrid apps.
                        </p>
                        <p>
                          <strong>Understand pricing</strong> for essential
                          features such as user authentication, payment
                          gateways, push notifications, and real-time chat.
                        </p>

                        <p>
                          {" "}
                          <strong>Plan your budget</strong> based on the scope,
                          complexity, and technology stack of your application.
                          <div id="item-2"></div>
                        </p>
                      </div>
                    </div>
                ...
                <div class="scrollspy-example-item right-side-content">
                  ...
                  <p>
                    Our calculator simplifies the process by breaking down the
                    app development cost into key components:
                  </p>
                  <div class="card-container">
                    <div class="app-cost-card">
                      ...
                      <div class="card-content">
                        <p>
                          <strong>Choose Your Platform</strong> – Select between{" "}
                          <strong>iOS, Android, or cross-platform</strong>{" "}
                          development.
                        </p>
                      </div>
                    </div>
                    <div class="app-cost-card">
                      ...
                      <div class="card-content">
                        <p>
                          <strong>Select Core Features</strong> – Pick features
                          like{" "}
                          <strong>
                            social login, eCommerce, GPS tracking, AI-based
                            recommendations, or API integrations.
                          </strong>
                        </p>
                      </div>
                    </div>
                    <div class="app-cost-card">
                      ...
                      <div class="card-content">
                        <p>
                          <strong>Define App Complexity</strong> – Choose
                          whether you need a{" "}
                          <strong>basic, mid-level, or enterprise-grade</strong>{" "}
                          app.
                        </p>
                      </div>
                    </div>
                    <div class="app-cost-card">
                      ...
                      <div class="card-content">
                        <p>
                          <strong>Estimate Development Timeline</strong> – Get
                          insights on how long it takes to build your app and
                ...
                <div class="scrollspy-example-item right-side-content">
                  ...
                  <p>
                    Several factors determine how much it costs to build an app.
                    Our app cost estimator considers:
                  </p>
                  <div class="row cost-calculator">
                    ...
                    <div class="col-lg-6 col-12">
                      <p>
                        <strong>App Type & Functionality</strong> – Basic apps
                        cost less, while AI-driven or enterprise applications
                        require more investment.
                      </p>
                      <p>
                        <strong>Technology Stack</strong> – Using{" "}
                        <strong>
                          native, hybrid, or progressive web app (PWA)
                          technologies
                        </strong>{" "}
                        impacts pricing.
                      </p>
                      <p>
                        <strong>Backend Development</strong> – Integrating APIs,
                        cloud storage, and databases can influence costs.
                      </p>
                      <p>
                        <strong>UI/UX Design</strong> – Custom graphics and
                        animations require more resources than standard
                        templates.
                      </p>
                      <p>
                        <strong>Security & Compliance</strong> – If your app
                        deals with sensitive data, it may require{" "}
                        <strong>HIPAA, GDPR, or PCI-DSS compliance.</strong>
                      </p>
                    </div>
                    <div id="item-4"></div>
                  </div>
                ...
                <div class="scrollspy-example-item right-side-content">
                  <h2>
                    Frequently Asked Questions (FAQs) About App Cost Calculator
                  </h2>
                  <p>
                    We hope the information below provides you with a clear
                    understanding of how our App Cost Calculator works, helping
                    you estimate your app development budget with transparency
                    and ease.
                  </p>
                  <div class="container-faq">
                    <div class="accordion">
                      <div class="accordion-item">
                        ...
                        >
                          <span class="accordion-title">
                            How does the App Cost Calculator work?
                          </span>
                          <span class="icon" aria-hidden="true"></span>
                        </button>
                        <div class="accordion-content">
                          <p>
                            Our <strong>App Cost Calculator</strong> provides a
                            quick and transparent estimate of your{" "}
                            <strong>mobile app development cost</strong> based
                            on factors like platform (iOS, Android, or
                            cross-platform), app complexity, features,
                            integrations, and design requirements. Simply select
                            your preferences, and the tool will generate an
                            approximate cost breakdown instantly.
                          </p>
                        </div>
                      </div>
                      <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                          <p>
                            • <strong>Platform choice</strong> (iOS, Android, or
                            both)
                          </p>
                          <p>
                            • <strong>complexity</strong> (e.g., user
                            authentication, AI, payment gateways)
                          </p>
                          <p>
                            • <strong>UI/UX design requirements</strong>
                          </p>
                          <p>
                            •{" "}
                            <strong>
                              Backend infrastructure and database integration
                            </strong>
                          </p>
                          <p>
                            • <strong>Third-party API integrations</strong>
                          </p>
                          <p>
                            •{" "}
                            <strong>
                      ...
                      <div class="accordion-item">
                        <button
                          onClick={() => togglefunc(3)}
                          id="accordion-button-3"
                          aria-expanded={openItem === 3}
                          className={openItem === 3 ? "active" : ""}
                        >
                          <span class="accordion-title">
                            Is the cost estimate provided by the calculator
                            accurate?
                          </span>
                          <span class="icon" aria-hidden="true"></span>
                        </button>
                        <div class="accordion-content">
                          <p>
                            Yes, our <strong>app cost estimator </strong>uses
                            industry-standard pricing models and real-time
                            market data to generate accurate estimates. However,
                            the final cost may vary depending on project scope,
                            custom requirements, and additional features. For a
                            more precise quote, you can schedule a free
                      ...
                      <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                          <p>
                            The cost of app development varies widely based on
                            complexity:
                          </p>
                          <p>
                            • <strong>Basic apps</strong> (e.g., simple utility
                            apps) – $10,000 to $30,000
                          </p>
                          <p>
                            • <strong>Mid-level apps</strong> (e.g., eCommerce,
                            on-demand services) – $30,000 to $100,000
                          </p>
                          <p>
                            • <strong>Enterprise or AI-powered apps</strong> –
                            $100,000+
                          </p>
                          <p>
                            The cost of app development varies widely based on
                      ...
                      <div class="accordion-item">
                        <button
                          onClick={() => togglefunc(5)}
                          id="accordion-button-5"
                          aria-expanded={openItem === 5}
                          className={openItem === 5 ? "active" : ""}
                        >
                          <span class="accordion-title">
                            Can I use the calculator for both iOS and Android
                            apps?
                          </span>
                          <span class="icon" aria-hidden="true"></span>
                        </button>
                        <div class="accordion-content">
                          <p>
                            Yes! Our tool provides estimates for{" "}
                            <strong>
                              iOS app development, Android app development, and
                              cross-platform solutions.
                            </strong>{" "}
                            You can compare costs and decide the best approach
                            for your project.
                          </p>
                        </div>
                      </div>
                      <div class="accordion-item">
                        ...
                        >
                          <span class="accordion-title">
                            What if my app has unique requirements not covered
                            in the calculator?
                          </span>
                          <span class="icon" aria-hidden="true"></span>
                        </button>
                        <div class="accordion-content">
                          <p>
                            If you need <strong>custom app development</strong>{" "}
                            with unique features, integrations, or compliance
                            requirements, reach out to us for a{" "}
                            <strong>personalized consultation</strong>. Our team
                            will analyze your needs and provide a detailed cost
                            breakdown beyond the calculator’s estimate.
                          </p>
                        </div>
                      </div>
                      <div class="accordion-item">
                        ...
                        >
                          <span class="accordion-title">
                            Does the app cost estimate include maintenance and
                            updates?
                          </span>
                          <span class="icon" aria-hidden="true"></span>
                        </button>
                        <div class="accordion-content">
                          <p>
                            No, the initial estimate covers only the{" "}
                            <strong>app development cost</strong>. However, we
                            offer{" "}
                            <strong>
                              app maintenance and post-launch support
                            </strong>{" "}
                            plans to help you scale, optimize, and secure your
                      ...
                      <div class="accordion-item">
                        ...
                        <div class="accordion-content">
                          ...
                          <p>
                            • <strong>Simple apps</strong> – 1 to 3 months
                          </p>
                          <p>
                            • <strong>Mid-level apps</strong> – 3 to 6 months
                          </p>
                          <p>
                            • <strong>Enterprise apps</strong> – 6+ months
                          </p>
                          <p>
                            Our <strong>App Cost Calculator</strong> also
                            provides a rough estimate of the development
                            timeline based on your selected features.
                          </p>
                        </div>
                      </div>
                      <div class="accordion-item">
                        ...
                        >
                          <span class="accordion-title">
                            Do you offer custom pricing for startups and
                            enterprises?
                          </span>
                          <span class="icon" aria-hidden="true"></span>
                        </button>
                        <div class="accordion-content">
                          <p>
                            Yes! We provide{" "}
                            <strong>
                              flexible app development pricing models
                            </strong>{" "}
                            for startups, SMBs, and enterprises. Whether you
                            need an{" "}
                            <strong>
                              MVP for fundraising or a full-scale enterprise
                            </strong>{" "}
                            solution, we tailor the pricing to your budget and
                            goals.
                          </p>
                        </div>
                      </div>
                      <div class="accordion-item">
                        ...
                        >
                          <span class="accordion-title">
                            How do I get started with app development after
                        ...
                        <div class="accordion-content">
                          <p>
                            Once you get your <strong>app cost estimate</strong>
                            , the next step is to{" "}
                            <strong>schedule a free consultation</strong> with
                            our experts. We’ll discuss your project in detail,
                            refine the requirements, and create a custom
                            development roadmap for your app.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div
                  class="scrollspy-example-item right-side-content"
                  id="item-5"
                >
                  <div class="container">
                    <div class="row">
                      <div class="col-lg-12 col-12 book-sectionInfo">
                        <div class="book-section-info">
                          <h2 class="mb-4">
                            Why Choose Taction Software for App Development?
                          </h2>
                          <p>
                            <strong>Proven Expertis</strong>e – 10+ years of
                            experience in{" "}
                            <strong>custom app development</strong> across
                            industries like{" "}
                            <strong>
                              healthcare, fintech, eCommerce, and logistics.
                            </strong>
                          </p>
                          <div class="row choose-us">
                            <div class="col-lg-6 col-12">
                              ...
                              <p>
                                <strong>Agile Methodology</strong> – We follow a{" "}
                                <strong>transparent and flexible</strong>{" "}
                                development approach to optimize costs and
                                reduce time-to-market.
                              </p>
                              <p>
                                <strong>Scalability & Innovation</strong> – We
                                build <strong>future-ready</strong> apps that
            ...
            <div class="col-lg-4 col-12">
              <div class="custom-block d-flex flex-wrap">
                ...
                <div class="custom-block-info review-card">
                  ...
                  <p class="mb-0 client-review">
                    "Taction Software delivered our healthcare app within budget
                    and ahead of schedule. The cost estimation from their App
                    Cost Calculator was incredibly accurate. Highly recommend
                    their team!"
                  </p>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-12 my-5 my-lg-0">
              <div class="custom-block d-flex flex-wrap">
                ...
                <div class="custom-block-info review-card">
                  ...
                  <p class="mb-0 client-review">
                    "Their cost estimator helped us budget properly before
                    development. The final product exceeded our expectations –
                    intuitive design, seamless performance, and great
                    post-launch support."
                  </p>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-12">
              <div class="custom-block d-flex flex-wrap">
                ...
                <div class="custom-block-info review-card">
                  ...
                  <p class="mb-0 client-review">
                    "We needed a logistics tracking app with real-time updates.
                    Taction Software’s team provided a transparent pricing
                    estimate, and the final result was outstanding. The cost
          ...
          <div class="row cost-estimate-cta">
            ...
            <div class="col-lg-6 col-12 mt-5 mt-lg-0">
              ...
              <p>
                ...
                <strong>Use our App Cost Calculator</strong> to get a detailed
                estimate tailored to your requirements.
              </p>
              <p>
                Whether you need a{" "}
                <strong>
                  startup app, enterprise solution, or an innovative MVP
                </strong>
                , we provide a precise cost breakdown to help you make informed
                decisions
              </p>
              <div class="col-lg-8 col-md-10 col-8 cta-btn">
                <a
                  href="#calculator-form"
                  className="custom-btn smoothscroll me-3"
                >
                  {" "}
                  👉 Try Our App Cost Calculator Now!
                </a>
              </div>
            </div>
          </div>
      ...
      <section className="contact-section section-padding" id="section_5">
              ...
              <div className="footer_content-address">
                <div className="footer_one">
                  <div className="footer-logo">
                    <img src={australia} className="" alt="Australia Address" />
                  </div>
                  <p className="mb-3">
                    1016 W<br />
                ...
                London, United Kingdom */}
                  ...
                  <p>
                    <a
                      href="mailto:info@tactionsoft.com"
                      className="contact-link mail-info"
                    >
                      info@tactionsoft.com
                    </a>
                  </p>
                ...
                <div className="footer_one">
                  <div className="footer-logo">
                    <img src={cheyenne} className="" alt="Australia Address" />
                  </div>
                  <p className="mb-3">
                    1603 Capitol Ave
                    <br />
                ...
                <div className="footer_one">
                  <div className="footer-logo footer-austin">
                    <img src={austin} className="" alt="Austin" />
                  </div>
                  <p className="mb-3">
                    5301 Southwest Pkwy.
                    <br />
                ...
                <div className="footer_one">
                  <div className="footer-logo footer-california">
                    <img src={california} className="" alt="California" />
                  </div>
                  <p className="mb-3">
                    720 14th Street
                    <br />
        ...
        <div className="iso-content">
          <div className="container">
            <img
              src={dmca}
              className="img-fluid iso-content-image"
              alt="Profile 1"
            />
            <img
              src={cmmi3}
        ...
        <div className="footer-bottom">
          ...
          <p className="copyright-text">
            ...
            <a
              rel="nofollow"
              href="https://www.tactionsoft.com/"
              target="_blank"
            >
              Taction Software LLC
            </a>
          ...
          <p className="privacy-policy">
            <a
              rel="nofollow"
              href="https://tactionsoft.com/privacy-policy/?_gl=1*1pyskiy*_gcl_au*MTgyMDU1MTE4Mi4xNzM4MDQzMTUw"
              target="_blank"
            >
              Privacy Policy
            </a>
          ...
          <div className="social_media_content">
            <ul className="social-icon mb-4">
              ...
              <li className="social-icon-item">
                <a
                  href="https://x.com/TactionSoft"
                  className="social-icon-link bi bi-twitter-x"
                  target="_blank"
                  rel="noopener noreferrer"
                ></a>
              </li>
              ...
              <li className="social-icon-item">
                <a
                  href="https://www.linkedin.com/company/taction-software-llc/"
